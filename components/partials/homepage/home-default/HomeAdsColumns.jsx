...
const HomeAdsColumns = () => {
    ...
    async function getPromotions() {
        ...
        console.log("ADS", responseData);
        console.log("ADS", responseData);
        if (responseData) {
            setPromotion1(responseData[2])
            ...
            <div className="ps-container">
                <div className="row">
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <Promotion
                            link="/shop"
                            image={promotion1 ? promotion1.url : null}
                        />
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <Promotion
                            link="/shop"
                            image={promotion2 ? promotion2.url : null}
                        />
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <Promotion
                            link="/shop"
                            image={promotion3 ? promotion3.url : null}
                        />
                    </div>
                </div>
            </div>
