...
function App({ Component, pageProps }) {
    ...
    return (
        <>
            <Head>
                <title>Технические оборудования в разновидности | Kvant</title>
                ...
                <meta
                    name="keywords"
                    content="Kvant, BloomShop, Технические оборудования в разновидности, Интернет-магазин, купить крема, гели, лосьоны и другие предметы гигиенты по уходу за лицом и телом"
                />
                <meta
                    name="description"
