...
// /products?search=генератор&sort=views&order=desc
class ProductRepository {
    ...
    async getProductsByCategory(payload) {
        const reponse = await Repository.get(
            ...
            .then((response) => {
                console.log("resoponse products", response);
                if (response.data) {
                        return response.data;
                } else {
                    return null;
    ...
    async getProductsmostViewed() {
        const reponse = await Repository.get(
            `${baseUrl}/products?sort=views&order=desc`
        )
            .then((response) => {
                return response.data;
            })
